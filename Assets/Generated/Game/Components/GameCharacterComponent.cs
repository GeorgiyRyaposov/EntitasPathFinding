...
public partial class GameEntity {
    ...
    public Characters.CharacterComponent character { get { return (Characters.CharacterComponent)GetComponent(GameComponentsLookup.Character); } }
    public bool hasCharacter { get { return HasComponent(GameComponentsLookup.Character); } }

    public void AddCharacter(bool newActive, int newType) {
    ...
    public void ReplaceCharacter(bool newActive, int newType) {
        var index = GameComponentsLookup.Character;
        var component = (Characters.CharacterComponent)CreateComponent(index, typeof(Characters.CharacterComponent));
        component.Active = newActive;
        component.Type = newType;
